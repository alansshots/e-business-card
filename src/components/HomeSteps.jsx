...
function HomeSteps() {
  return (
    <div className='flex flex-col items-center justify-center mt-16'>
        <h1 className='text-[#013941] mt-10 mb-5 text-6xl'>HOW DOES IT WORK</h1>
        <div className='w-4/5 flex flex-row items-center justify-between mt-10'>
            <div className='bg-[#EFFAF5] flex flex-col items-start w-[300px] h-[180px] rounded-xl'>
                ...
                <p className='mx-4 my-4 w-4/5 text-md font-semibold text-left'>Register for a free account in our platform.</p>
            </div>
            <div className='bg-[#EFFAF5] flex flex-col items-start w-[300px] h-[180px] rounded-xl'>
                ...
                <p className='mx-4 my-4 w-4/5 text-md font-semibold text-left'>Set up your free digital personal card online here.</p>
            </div>
            <div className='bg-[#EFFAF5] flex flex-col items-start w-[300px] h-[180px] rounded-xl'>
                ...
                <p className='mx-4 my-4 w-4/5 text-md font-semibold text-left'>Share your digital card by tapping phones, sharing a link or simply let others scan your QR code.</p>
            </div>
        </div>
    </div>
  )
